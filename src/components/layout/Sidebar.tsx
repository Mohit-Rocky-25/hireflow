...
const NAV_ITEMS: Record<UserRole, NavItem[]> = {
  ...
  HR_RECRUITER: [
    ...
    { label: 'Candidates', path: '/company/candidates', icon: <Users className="w-5 h-5 stroke-[1.5px]" /> },
    { label: 'Analytics', path: '/company/analytics', icon: <BarChart3 className="w-5 h-5 stroke-[1.5px]" /> },
    { label: 'Notifications', path: '/company/notifications', icon: <Bell className="w-5 h-5 stroke-[1.5px]" /> },
  ],
  INTERVIEWER: [
    ...
    { label: 'Notifications', path: '/interviewer/notifications', icon: <Bell className="w-5 h-5 stroke-[1.5px]" /> },
  ],
  CANDIDATE: [
    ...
    { label: 'Resume & AI Match', path: '/candidate/resume', icon: <FileText className="w-5 h-5 stroke-[1.5px]" /> },
    { label: 'Company Match', path: '/candidate/company-match', icon: <Building2 className="w-5 h-5 stroke-[1.5px]" /> },
